...
def PredictRisk_1(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            features = [
                [form.cleaned_data['age'], form.cleaned_data['bp'], form.cleaned_data['sg'], form.cleaned_data['al'],
                 form.cleaned_data['su'],
                 form.cleaned_data['rbc'], form.cleaned_data['pc'], form.cleaned_data['pcc'], form.cleaned_data['ba'],
                 form.cleaned_data['bgr'], form.cleaned_data['bu'], form.cleaned_data['sc'], form.cleaned_data['sod'],
                 form.cleaned_data['pot'], form.cleaned_data['hemo'],
                 form.cleaned_data['pcv'], form.cleaned_data['wc'], form.cleaned_data['rc'], form.cleaned_data['htn'],
                 form.cleaned_data['dm'],
                 form.cleaned_data['cad'], form.cleaned_data['appet'], form.cleaned_data['pe'],
                 form.cleaned_data['ane']]]
            ...
            NNClassifier = GetAllClassifiersForKidney()
